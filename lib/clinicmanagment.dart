...
class ClinicManagment extends StatefulWidget {
  const ClinicManagment({Key? key}) : super(key: key);

  @override
  _ClinicManagmentState createState() => _ClinicManagmentState();
}

class _ClinicManagmentState extends State<ClinicManagment> {
